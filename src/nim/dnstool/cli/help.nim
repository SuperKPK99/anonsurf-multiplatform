...
proc show_banner() =
  echo("AnonSurf Multi-Platform DNS Tool")
  echo("A CLI tool to change DNS settings quickly")
  echo("Based on original work by Nong Hoang \"DmKnght\" Tu <dmknght@parrotsec.org>")
